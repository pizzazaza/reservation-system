                    ...
                    <div class="ticket_body">
                        ...
                        <div class="qty">
                            ...
                            <div class="qty_info_icon"> 
                            	...
                            	<em class="product_dsc"><%=priceInfo.get(i).get("discount_price") %>원 <%=discount_percent %>% 할인가)</em> 
                            </div>
                        </div>
                        <%
                        } 
                            ...
                            <form class="form_horizontal">
                                ...
                                <div class="inline_form last"> <label class="label" for="message">예매내용</label>
                                    <div class="inline_control">
                                        <p class="inline_txt selected"><%=productInfo.get("display_start") %> ~ <%=productInfo.get("display_end") %>, 총 0매</p>
                                    </div>
                                </div>
                            </form>
                        </div>
